-- megafunction wizard: %DDR3 High Performance Controller v13.1%
-- GENERATION: XML

-- ============================================================
-- Megafunction Name(s):
-- 			scu_ddr3_controller_phy
-- ============================================================
-- Generated by DDR3 High Performance Controller 13.1 [Altera, IP Toolbench 1.3.0 Build 162]
-- ************************************************************
...
ARCHITECTURE SYN OF scu_ddr3 IS
	...
	COMPONENT scu_ddr3_controller_phy
	PORT (
		local_address	: IN STD_LOGIC_VECTOR (23 DOWNTO 0);
		local_write_req	: IN STD_LOGIC;
		local_read_req	: IN STD_LOGIC;
...
BEGIN
	...
	scu_ddr3_controller_phy_inst : scu_ddr3_controller_phy
	PORT MAP (
...
-- Retrieval info: <MEGACORE title="DDR3 SDRAM Controller with ALTMEMPHY"  version="13.1"  build="162"  iptb_version="1.3.0 Build 162"  format_version="120" >
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="scu_ddr3_controller_phy" >
...
-- Retrieval info:      <PRIVATE name = "pll_ref_clk_mhz" value="62.5"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "pll_ref_clk_ps_label" value="(16000 ps)"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "fast_simulation_en" value="DISABLED"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "ctl_lookahead_depth" value="6"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "t_IH" value="0.24"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "addr_cmd_slew_rate" value="2.0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "board_tpd_inter_DIMM" value="0.05"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "board_addresscmd_CK_skew" value="-0.045"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "t_DS_calculated" value="0.205"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "isi_addresscmd_hold" value="0.0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "t_IS" value="0.241"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "restore_default_toggle" value="false"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "dqs_dqsn_slew_rate" value="1.8"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "dq_slew_rate" value="1.5"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "t_IS_calculated" value="0.240"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "t_DH" value="0.174"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "ck_ckn_slew_rate" value="4.0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "isi_DQ" value="0.0"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "t_IH_calculated" value="0.240"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "t_DH_calculated" value="0.174"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "t_DS" value="0.205"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen">
-- Retrieval info:      <PRIVATE name = "use_alt_top" value="1"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "alt_top" value="scu_ddr3_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_excludes" value="scu_ddr3_phy_alt_mem_phy_seq_wrapper.vhd,scu_ddr3_phy_alt_mem_phy_seq_wrapper.v,scu_ddr3_phy.vhd,scu_ddr3_phy_alt_mem_phy.v,alt_mem_phy_defines.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "nativelink_includes" value="scu_ddr3_phy.vho,scu_ddr3_phy_alt_mem_phy_seq_wrapper.vho"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "filename" value="scu_ddr3_alt_mem_ddrx_controller_top.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen2">
-- Retrieval info:      <PRIVATE name = "family" value="Arria II GX"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+scu_ddr3_alt_mem_phy_seq_wrapper;+scu_ddr3_alt_mem_phy_reconfig;+scu_ddr3_alt_mem_phy_pll;+scu_ddr3_phy_alt_mem_phy_delay;+scu_ddr3_alt_mem_phy_dq_dqs --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/kkaiser/bel_projects/modules/ddr3/scu_ddr3_simgen_init.txt"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="scu_ddr3_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
