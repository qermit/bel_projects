...
CBR_PF   := ""
CBR_GIT1  := `git log HEAD~0 --oneline --decorate=short -n 1`
CBR_GIT2  := `git log HEAD~1 --oneline --decorate=short -n 1`
CBR_GIT3  := `git log HEAD~2 --oneline --decorate=short -n 1`
CBR_GIT4  := `git log HEAD~3 --oneline --decorate=short -n 1`
CBR_GIT5  := `git log HEAD~4 --oneline --decorate=short -n 1`
